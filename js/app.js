class CalorieTracker {
    // this constructor renders each of these every time the app is loaded
    constructor() {
    ...
    // displaying new meal & workout in DOM
    ...
    // changes the calories when you add meal or workout, you call it in those methods
    _render() {
        this._displayCaloriesTotal();
        this._displayCaloriesConsumed();
        this._displayCaloriesBurned();
...
class Storage {
    ...
    static clearAll(){
        ...
        // if you want to clear out everything
        // localStorage.clear();
    }
}
...
class App {
  ...
  // adding a new meal/workout in the form submission
    _newItem(type, e){
        ...
        if(type === 'meal'){
            // adding '+' to the beginning of calories turns this into a number 
    ...
    _filterItems(type, e){
        // adding a .toLowerCase enables to search by upper/lower case
